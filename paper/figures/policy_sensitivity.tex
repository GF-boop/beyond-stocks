...
$r_c=10\%$\,$^{\dagger}$ & \emph{7.36\%} & \emph{10.00\%} & 1.83\% & 5.32\% & 2.51\% & 6.39\% \\
$r_c=15\%$ & \emph{7.36\%} & \emph{15.00\%} & 1.83\% & 7.63\% & 2.51\% & 9.21\% \\
\addlinespace
\multicolumn{7}{l}{\emph{Withdrawal rate $r_w$ (contribution held at 10\%)}} \\
$r_w=3\%$ & \emph{2.66\%} & \emph{10.00\%} & 0.90\% & 5.77\% & 1.14\% & 6.88\% \\
$r_w=4\%$\,$^{\dagger}$ & \emph{7.36\%} & \emph{10.00\%} & 1.83\% & 5.32\% & 2.51\% & 6.39\% \\
$r_w=5\%$ & \emph{15.93\%} & \emph{10.00\%} & 4.59\% & 4.49\% & 6.38\% & 5.49\% \\
\bottomrule
\end{tabular}
