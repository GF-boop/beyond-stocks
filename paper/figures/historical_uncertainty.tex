...
\midrule
Full panel, 5-year blocks & 1{,}557 & \emph{8.88\%} & 2.68\% & 5.32\% & 3.18\% & 6.40\% \\
Full panel, 10-year blocks & 1{,}557 & \emph{6.96\%} & 1.94\% & 5.33\% & 2.76\% & 6.39\% \\
Full panel, 20-year blocks & 1{,}557 & \emph{6.40\%} & 1.32\% & 5.45\% & 1.74\% & 6.57\% \\
1950--2025, 10-year blocks & 1{,}213 & \emph{5.88\%} & 0.38\% & 4.88\% & 0.62\% & 5.65\% \\
1970--2025, 10-year blocks & 894 & \emph{4.52\%} & 0.20\% & 4.15\% & 0.22\% & 4.90\% \\
Investability screen, 10-year blocks & 1{,}527 & \emph{5.16\%} & 0.46\% & 5.29\% & 0.72\% & 6.28\% \\
LOO minimum (16 countries) & 1{,}458--1{,}466 & \emph{6.28\%} & 1.22\% & 5.28\% & 1.80\% & 6.31\% \\
LOO median (16 countries) & 1{,}458--1{,}466 & \emph{7.46\%} & 2.02\% & 5.41\% & 2.68\% & 6.50\% \\
LOO maximum (16 countries) & 1{,}458--1{,}466 & \emph{8.16\%} & 2.22\% & 5.52\% & 2.88\% & 6.68\% \\
\bottomrule
\end{tabular}
